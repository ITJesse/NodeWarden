...
const ru: Record<string, string> = {
  ...
  "txt_master_password_must_be_at_least_12_chars": "Мастер-пароль должен содержать не менее 10 символов.",
  ...
  "txt_new_password_must_be_at_least_12_chars": "Новый пароль должен содержать не менее 10 символов.",

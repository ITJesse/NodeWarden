...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    txt_master_password_must_be_at_least_12_chars: "Master password must be at least 10 chars",
    ...
    txt_new_password_must_be_at_least_12_chars: "New password must be at least 10 chars",
...
const zhCNOverrides: Record<string, string> = {
  ...
  txt_master_password_must_be_at_least_12_chars: '主密码至少需要 10 个字符',
  txt_moved_selected_items: '已移动所选项目',
  txt_name_is_required: '名称不能为空',
  txt_new_password_must_be_at_least_12_chars: '新密码至少需要 10 个字符',
